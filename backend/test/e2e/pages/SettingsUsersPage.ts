...
export class SettingsUsersPage extends BasePage {
  ...
  get statFinance(): Locator {
    return this.page.getByTestId('stat-finance-value');
  }

  get statAcademic(): Locator {
    return this.page.getByTestId('stat-academic-value');
  }
  ...
  async expectStatsVisible(): Promise<void> {
    ...
    await expect(this.statFinance).toBeVisible();
    await expect(this.statAcademic).toBeVisible();
  }
