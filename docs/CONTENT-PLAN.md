# Content Plan - STMIK Tazkia Website

**Purpose:** Track article and news content for SEO and marketing
...
## SEO Articles (On-Site)

> Evergreen content to be published on stmik.tazkia.ac.id/news/

**Target Keywords:** kuliah IT Bogor, kampus informatika Bogor, jurusan sistem informasi, teknik informatika terbaik

### Program & Career (5 articles)

| # | Title | Status | Published | Author |
|---|-------|--------|-----------|--------|
| 1 | Prospek Kerja Lulusan Sistem Informasi 2026 | [ ] Draft [ ] Review [ ] Published | - | - |
| 2 | Perbedaan Sistem Informasi vs Teknik Informatika: Mana yang Cocok? | [ ] Draft [ ] Review [ ] Published | - | - |
| 3 | 10 Skill yang Harus Dikuasai Mahasiswa IT | [ ] Draft [ ] Review [ ] Published | - | - |
| 4 | Gaji Fresh Graduate IT di Indonesia | [ ] Draft [ ] Review [ ] Published | - | - |
| 5 | Peluang Karir di Bidang Data Science dan AI | [ ] Draft [ ] Review [ ] Published | - | - |

### Industry Trends (5 articles)

| # | Title | Status | Published | Author |
|---|-------|--------|-----------|--------|
| 1 | Tren Teknologi 2026 yang Wajib Dipelajari Mahasiswa | [ ] Draft [ ] Review [ ] Published | - | - |
| 2 | Peluang Karir di Industri Halal Tech | [ ] Draft [ ] Review [ ] Published | - | - |
| 3 | Cybersecurity: Profesi Masa Depan dengan Permintaan Tinggi | [ ] Draft [ ] Review [ ] Published | - | - |
| 4 | Machine Learning untuk Pemula: Panduan Lengkap | [ ] Draft [ ] Review [ ] Published | - | - |
| 5 | Cloud Computing dan Peluang Sertifikasi | [ ] Draft [ ] Review [ ] Published | - | - |

### Student Life & Campus (4 articles)

| # | Title | Status | Published | Author |
|---|-------|--------|-----------|--------|
| 1 | Kehidupan Mahasiswa di STMIK Tazkia | [ ] Draft [ ] Review [ ] Published | - | - |
| 2 | Fasilitas Kampus STMIK Tazkia Bogor | [ ] Draft [ ] Review [ ] Published | - | - |
| 3 | Project-Based Learning: Belajar Sambil Praktek Langsung | [ ] Draft [ ] Review [ ] Published | - | - |
| 4 | Testimoni Alumni STMIK Tazkia | [ ] Draft [ ] Review [ ] Published | - | - |

### Admissions & Guides (4 articles)

| # | Title | Status | Published | Author |
|---|-------|--------|-----------|--------|
| 1 | Panduan Lengkap Pendaftaran STMIK Tazkia | [ ] Draft [ ] Review [ ] Published | - | - |
| 2 | Biaya Kuliah IT di Bogor: Perbandingan Kampus | [ ] Draft [ ] Review [ ] Published | - | - |
| 3 | Tips Memilih Jurusan IT yang Tepat | [ ] Draft [ ] Review [ ] Published | - | - |
| 4 | Beasiswa Kuliah IT untuk Mahasiswa Berprestasi | [ ] Draft [ ] Review [ ] Published | - | - |

### Local SEO - Bogor (3 articles)

| # | Title | Status | Published | Author |
|---|-------|--------|-----------|--------|
| 1 | Kampus IT Terbaik di Bogor | [ ] Draft [ ] Review [ ] Published | - | - |
| 2 | Kuliah Sambil Kerja di Bogor: Tips dan Rekomendasi | [ ] Draft [ ] Review [ ] Published | - | - |
| 3 | Komunitas IT di Bogor yang Wajib Diikuti | [ ] Draft [ ] Review [ ] Published | - | - |

---

## News Topics (Regular Updates)

> Event-based content, publish as events happen
...
| # | Title Template | Status | Published | Notes |
|---|----------------|--------|-----------|-------|
| 1 | Mahasiswa STMIK Tazkia Juara Kompetisi [X] | [ ] | - | Per achievement |
| 2 | Tim STMIK Tazkia Raih Penghargaan di Hackathon | [ ] | - | Per hackathon |
| 3 | Karya Mahasiswa Digunakan oleh [Klien Industri] | [ ] | - | Per project |
| 4 | Alumni STMIK Tazkia Sukses di [Perusahaan] | [ ] | - | Alumni spotlight |
...
| # | Title Template | Status | Published | Notes |
|---|----------------|--------|-----------|-------|
| 1 | Fasilitas Baru di Kampus STMIK Tazkia | [ ] | - | Per facility |
| 2 | Kurikulum Baru Berbasis Industri 4.0 | [ ] | - | Curriculum update |
| 3 | Akreditasi Program Studi [X] | [ ] | - | Per accreditation |
| 4 | Dosen STMIK Tazkia Raih [Penghargaan/Sertifikasi] | [ ] | - | Faculty achievement |
...
### Tech Media (Techinasia, Dailysocial, IDN Times Tech)

| # | Title | Target Site | Status | Published | Backlink |
|---|-------|-------------|--------|-----------|----------|
| 1 | Bagaimana Kampus Menyiapkan Talenta untuk Industri Halal Tech | Techinasia | [ ] Draft [ ] Submitted [ ] Published | - | [ ] |
| 2 | Project-Based Learning: Model Pendidikan IT Masa Depan | Dailysocial | [ ] Draft [ ] Submitted [ ] Published | - | [ ] |
| 3 | Kolaborasi Kampus-Industri dalam Mencetak Developer Siap Kerja | IDN Times | [ ] Draft [ ] Submitted [ ] Published | - | [ ] |

### Education Portals (Rencanamu, Quipper, Youthmanual)

| # | Title | Target Site | Status | Published | Backlink |
|---|-------|-------------|--------|-----------|----------|
| 1 | Mengenal Jurusan Sistem Informasi: Prospek dan Peluang | Rencanamu | [ ] Draft [ ] Submitted [ ] Published | - | [ ] |
| 2 | 5 Alasan Memilih Kuliah IT di Bogor | Quipper | [ ] Draft [ ] Submitted [ ] Published | - | [ ] |
| 3 | Kampus dengan Kurikulum Berbasis Proyek Nyata | Youthmanual | [ ] Draft [ ] Submitted [ ] Published | - | [ ] |

### Business/Halal Industry Media

| # | Title | Target Site | Status | Published | Backlink |
|---|-------|-------------|--------|-----------|----------|
| 1 | Peran Teknologi Informasi dalam Ekosistem Industri Halal | Republika | [ ] Draft [ ] Submitted [ ] Published | - | [ ] |
| 2 | Digital Transformation untuk UMKM Halal | Bisnis.com | [ ] Draft [ ] Submitted [ ] Published | - | [ ] |
| 3 | Kebutuhan Talenta IT di Industri Keuangan Syariah | Kontan | [ ] Draft [ ] Submitted [ ] Published | - | [ ] |

### Local Bogor Media

| # | Title | Target Site | Status | Published | Backlink |
|---|-------|-------------|--------|-----------|----------|
| 1 | STMIK Tazkia: Kampus IT Unggulan di Kota Bogor | Radar Bogor | [ ] Draft [ ] Submitted [ ] Published | - | [ ] |
| 2 | Kontribusi STMIK Tazkia untuk Pengembangan SDM Bogor | Tribun Bogor | [ ] Draft [ ] Submitted [ ] Published | - | [ ] |
| 3 | Kerjasama STMIK Tazkia dengan Pelaku Usaha Lokal Bogor | Bogor Today | [ ] Draft [ ] Submitted [ ] Published | - | [ ] |

### Tazkia Group Sites

| # | Title | Target Site | Status | Published | Backlink |
|---|-------|-------------|--------|-----------|----------|
| 1 | Sinergi Pendidikan Ekonomi Islam dan Teknologi Informasi | tazkia.ac.id | [ ] Draft [ ] Submitted [ ] Published | - | [ ] |
| 2 | Program Double Degree STEI Tazkia - STMIK Tazkia | STEI Tazkia | [ ] Draft [ ] Submitted [ ] Published | - | [ ] |
| 3 | Kolaborasi Riset Fintech Syariah | tazkia.ac.id | [ ] Draft [ ] Submitted [ ] Published | - | [ ] |
...
- Add internal links to program pages and contact
- Include call-to-action (CTA) for registration
- Optimal length: 1000-2000 words for articles

### Image Requirements
- Featured image: 1200x630px (OG image size)
- In-article images: 800px width max
- Alt text with keywords
- Compress before upload

### Publishing Workflow
1. **Draft** - Writer creates initial content
2. **Review** - Editor reviews for accuracy and SEO
3. **Publish** - Upload to website with proper metadata
4. **Promote** - Share on social media channels
